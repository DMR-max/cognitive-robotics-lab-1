...
function loadVehicle() {
  ...
  case 2: //Love
    ...
    simulationInfo.speedMultiplier = simulationInfo.speedMultiplier * 8;
    console.log(simulationInfo.speedMultiplier)
    break;
  case 3: //Exploration
    simulationInfo.bayVehicle.vehicle.baseValues = {left: 1, right: 1, bulb: 0};
    simulationInfo.bayVehicle.vehicle.sensors = [{position: -Math.PI/4, type: "right", strength: (-0.1)}, {position: Math.PI/4, type: "left", strength: (-0.1)}];
    simulationInfo.speedMultiplier = simulationInfo.speedMultiplier * 4;
    break;
  default:
