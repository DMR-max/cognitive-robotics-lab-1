...
braitenbergInfo = {
  vehicles: [
    ...
    {x: 200, y: 200, color: "white", angle: 0, baseValues: {left: 1, right: 1, bulb: 0}, sensors: [{position: -Math.PI/4, type: "right", strength: 1}, {position: Math.PI/4, type: "left", strength: 1}]}],
...
function loadVehicle() {
  var i, newInfo;
  console.log(document.getElementById("vehicleSelectBox").selectedIndex)
  switch(document.getElementById("vehicleSelectBox").selectedIndex) {
    case 0: //Aggression
      simulationInfo.bayVehicle.vehicle.color = "red"
      ...
      simulationInfo.speedMultiplier = 5;
      break;
    case 1: //Fear
      simulationInfo.bayVehicle.vehicle.color = "green"
      simulationInfo.bayVehicle.vehicle.baseValues = {left: 1, right: 1, bulb: 0};
      simulationInfo.bayVehicle.vehicle.sensors = [{position: Math.PI/4, type: "right", strength: 1}, {position: -Math.PI/4, type: "left", strength: 1}];
      simulationInfo.speedMultiplier = 5;
      break;
    case 2: //Love
      simulationInfo.bayVehicle.vehicle.color = "blue"
      simulationInfo.bayVehicle.vehicle.baseValues = {left: 1, right: 1, bulb: 0};
      simulationInfo.bayVehicle.vehicle.sensors = [{position: Math.PI/4, type: "right", strength: -0.1}, {position: -Math.PI/4, type: "left", strength: -0.1}];
      simulationInfo.speedMultiplier = 5 * 3;
      break;
    case 3: //Exploration
      simulationInfo.bayVehicle.vehicle.color = "white"
      simulationInfo.bayVehicle.vehicle.baseValues = {left: 1, right: 1, bulb: 0};
      simulationInfo.bayVehicle.vehicle.sensors = [{position: -Math.PI/4, type: "right", strength: -0.1}, {position: Math.PI/4, type: "left", strength: -0.1}];
      simulationInfo.speedMultiplier = 5 * 3;
      break;
